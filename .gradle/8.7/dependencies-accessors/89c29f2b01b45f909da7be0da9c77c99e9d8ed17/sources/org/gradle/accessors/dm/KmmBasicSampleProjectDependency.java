...
@NonNullApi
public class KmmBasicSampleProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KmmBasicSampleProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
